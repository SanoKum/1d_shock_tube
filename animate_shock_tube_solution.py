...
if __name__ == '__main__':
    ...
    file_names_1st = sorted(glob.glob('./noMUSCL/results_time_*.dat'))
    ...
    for fname1, fname2 in zip(file_names_1st, file_names_MUSCL):
        ...
        axes[0,0].plot(x_cfd, r_cfd, label="Roe Solver no MUSCL", linestyle='None', marker="o", markersize=3, color="red")
        ...
        axes[1,0].plot(x_cfd, p_cfd, label="Roe Solver no MUSCL", linestyle='None', marker="o", markersize=3, color="red")
        ...
        axes[0,1].plot(x_cfd, u_cfd, label="Roe Solver no MUSCL", linestyle='None', marker="o", markersize=3, color="red")
        ...
        axes[1,1].plot(x_cfd , int_eng_cfd , label="Roe Solver no MUSCL", linestyle='None', marker="o", markersize=3, color="red")
