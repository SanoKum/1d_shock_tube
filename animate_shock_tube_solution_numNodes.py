...
if __name__ == '__main__':
    ...
    file_names_1st = sorted(glob.glob('./MUSCL/results_time_*.dat'))
    file_names_MUSCL = sorted(glob.glob('./MUSCL_500nodes/results_time_*.dat'))
    ...
    for fname1, fname2 in zip(file_names_1st, file_names_MUSCL):
        ...
        axes[0,0].plot(x_cfd, r_cfd, label="Roe Solver 100cells", linewidth=2, color="red")
        axes[0,0].plot(x_cfd2, r_cfd2, label="Roe Solver 500cells" , linewidth=2,color="blue")
        ...
        axes[1,0].plot(x_cfd, p_cfd, label="Roe Solver 100cells", linewidth=2, color="red")
        axes[1,0].plot(x_cfd2, p_cfd2, label="Roe Solver 500cells" , linewidth=2,color="blue")
        ...
        axes[0,1].plot(x_cfd, u_cfd, label="Roe Solver 100cells", linewidth=2, color="red")
        axes[0,1].plot(x_cfd2, u_cfd2, label="Roe Solver 500cells" , linewidth=2, color="blue")
        ...
        axes[1,1].plot(x_cfd , int_eng_cfd , label="Roe Solver 100cells", linewidth=2,color="red")
        axes[1,1].plot(x_cfd2, int_eng_cfd2, label="Roe Solver 500cells"   , linewidth=2,  color="blue")
