...
if __name__ == '__main__':
    ...
    axes[0,0].plot(x_cfd, r_cfd, label="JST Solver 1", linestyle='None', marker="o", markersize=3, color="red")
    ...
    axes[1,0].plot(x_cfd, p_cfd, label="JST Solver 1", linestyle='None', marker="o", markersize=3, color="red")
